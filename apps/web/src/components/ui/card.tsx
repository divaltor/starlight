...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return <div className={cn("card bg-base-100 shadow-sm", className)} data-slot="card" {...props} />;
}
...
function CardDescription({ className, ...props }: React.ComponentProps<"div">) {
  return <div className={cn("text-base-content/60 text-sm", className)} data-slot="card-description" {...props} />;
}
...
function CardContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div className={cn("card-body px-6 [&:not(:first-child)]:pt-6", className)} data-slot="card-content" {...props} />
  );
}
