...
import { Dialog as AriaDialog, DialogTrigger as AriaDialogTrigger } from "react-aria-components/Dialog";
...
function DialogTrigger({ children, ...props }: React.ComponentProps<typeof AriaDialogTrigger>) {
