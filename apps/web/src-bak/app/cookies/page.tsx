...
import { cookiesToRfcString, decodeCookies } from "apps/web/src-bak/lib/utils";
import {
	AlertTriangle,
	CheckCircle,
	Clipboard,
...
import {
	...
	AccordionItem,
	AccordionTrigger,
} from "apps/web/src-bak/components/ui/accordion";
import {
	Alert,
	AlertDescription,
	AlertTitle,
...
import { Textarea } from "apps/web/src-bak/components/ui/textarea";
							...
							{!isMainButtonMounted && (
								<div className="flex justify-center">
									<Button
										...
										className="flex w-full max-w-sm items-center gap-2 bg-primary hover:bg-primary/90"
										size="lg"
									>
							...
							<Accordion type="multiple" className="w-full">
									...
									<AccordionContent className="px-6 pb-4">
										<div className="space-y-4">
											<div className="flex items-start gap-3">
												<HardDrive className="mt-0.5 h-5 w-5 flex-shrink-0 text-primary" />
												<div>
								...
								<AccordionItem value="supported-formats">
									...
									<AccordionContent className="px-6 pb-4">
										<div className="space-y-4">
											<div className="flex items-start gap-3">
												<Clipboard className="mt-0.5 h-5 w-5 flex-shrink-0 text-secondary-500" />
												<div>
