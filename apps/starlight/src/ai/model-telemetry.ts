...
import type * as Usage from "@/ai/usage";
...
function generationAttributes(input: GenerationInput): Attributes {
  const attributes: Attributes = {
    ...
    ...optionalNumber("starlight.model.billing.cache_read_tokens", input.usage.billing.cacheReadTokens),
    ...optionalNumber("starlight.model.billing.cache_write_tokens", input.usage.billing.cacheWriteTokens),
    ...
    ...optionalNumber("starlight.model.billing.reasoning_tokens", input.usage.billing.reasoningTokens),
