...
import { Search, ImageIcon, User, Settings, LogOut, Plus, Images } from 'lucide-react';
  ...
  useEffect(() => {
    const checkCookiesAndUser = async () => {
      ...
      if (typeof window !== 'undefined' && window.Telegram?.WebApp?.CloudStorage) {
        try {
          window.Telegram.WebApp.CloudStorage.getItem('user_cookies', (error, value) => {
            if (!error && value) {
              cookiesFound = true;
            }
          ...
          <CardContent className="pt-6">
            ...
            <div className="text-center py-12 border-2 border-dashed border-muted rounded-lg">
              ...
              <p className="text-muted-foreground mb-6">
                Your photo gallery is empty. Connect your Twitter account to start viewing photos.
              </p>
              {!hasCookies && (
                <Link href="/cookies">
